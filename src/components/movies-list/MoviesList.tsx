...
import { Row, Col, Alert, Navbar, Nav, Form, FormControl, Button } from 'react-bootstrap';
import MoviesListItem from './MoviesListItem';
import LoadingIndicator from '../common/LoadingIndicator';
import IMovies from '../../modules/IMovies';
import { LoadingStatus } from '../../modules/types';
...
class MoviesList extends Component<Props, State> {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            const movieList = data.filter((list: { title: string; }) => {
                if (this.props.query === '') {
                    return list;
                } else {
